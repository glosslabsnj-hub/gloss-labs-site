...
export function TestimonialCard({ name, vehicle, text, rating }: TestimonialCardProps) {
  return (
    <div className="glass-card rounded-2xl p-8 h-full flex flex-col">
      ...
      <p className="text-white/60 text-sm leading-relaxed mb-6 italic font-[family-name:var(--font-body)] flex-1">
        &ldquo;{text}&rdquo;
      </p>

      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-accent to-accent-glow flex items-center justify-center shrink-0">
