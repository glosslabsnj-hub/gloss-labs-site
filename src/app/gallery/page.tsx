...
import { galleryItems, galleryCategories, siteInfo } from "@/data/content";
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map((item, index) => (
              <ScrollReveal key={item.id} delay={index * 80} direction="up" distance={20}>
                <div
