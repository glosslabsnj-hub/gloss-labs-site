...
export const metadata: Metadata = {
  ...
  description: "Schedule your mobile detailing appointment online. We come to you in Hamilton NJ and surrounding areas.",
};
    ...
    <>
      ...
      <section className="pt-32 pb-12 bg-black relative">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <span className="text-gold text-xs tracking-[0.3em] uppercase">Schedule Online</span>
          <h1 className="text-4xl md:text-6xl font-bold mt-3 mb-4">
            Book Your <span className="text-gradient-gold">Detail</span>
          </h1>
          <p className="text-white/40 text-lg max-w-2xl mx-auto">
            Pick a service, choose a time, and we&apos;ll come to you. It&apos;s that simple.
          </p>
        </div>
      </section>
          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <a
                ...
                className="flex items-center gap-2 text-gold hover:text-gold-light transition-colors duration-300 cursor-pointer"
              >
